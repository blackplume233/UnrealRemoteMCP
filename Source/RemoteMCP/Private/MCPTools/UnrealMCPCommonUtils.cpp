...
FVector FUnrealMCPCommonUtils::GetVectorFromJson(const FJsonObjectParameter& JsonObject, const FString& FieldName)
{
    return GetVectorFromJson(JsonObject.GetJsonObject(),FieldName);
}
